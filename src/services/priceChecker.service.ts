...
export const sendPriceDropNotification = async (
  ...
  try {
    ...
    //     <h2 style="color: #4CAF50;">Great News! Prices Have Dropped!</h2>

    //     <p>Hello ${user.firstName},</p>

    //     <p>We found a better price for your trip <strong>${
    //       trip.tripName
    //     }</strong>!</p>

    //     <div style="background-color: #684646FF; padding: 20px; border-radius: 8px; margin: 20px 0;">
    //       <h3 style="margin-top: 0;">Price Comparison:</h3>
    ...
    //               ${formatPriceWithSymbol(oldPrice, currency)}
    //             </span>
    //           </td>
    //         </tr>
    //         <tr>
    ...
    //           </td>
    //           <td style="padding: 10px; border-bottom: 1px solid #ddd; text-align: right; color: #4CAF50; font-size: 18px;">
    //             <strong>${formatPriceWithSymbol(newPrice, currency)}</strong>
    //           </td>
    //         </tr>
    //         <tr>
    ...
    //             <strong>${formatPriceWithSymbol(
    //               oldPrice - newPrice,
    //               currency
    //             )} (${percentageChange.toFixed(1)}%)</strong>
    //           </td>
    //         </tr>
    //       </table>
    //     </div>
    ...
    //       <em>Note: Flight prices can change frequently. We recommend booking soon to secure this price.</em>
    //     </p>

    //     <div style="margin-top: 30px; padding-top: 20px; border-top: 1px solid #ddd; color: #999; font-size: 12px;">
    //       <p>This is an automated notification from Travel Planner. To stop receiving price alerts for this trip, please update your notification preferences.</p>
    //     </div>
    //   </div>
    // `;
